...
class Localizer:
    def __init__(self, ep_robot, Map, position=(0,0,0), num_particles=100, movement_perturbation=0.1, rotation_perturbation=0.1, perturbation_uniform=True, update_steps=0):
        
        self.ep_robot = ep_robot
        self.Map = Map
        self.mc = MonteCarloLocalization(Map, num_particles=num_particles, initial_position=position)
        self.last_scan = None
        self.perturbation_param = (rotation_perturbation,movement_perturbation,movement_perturbation, perturbation_uniform)
